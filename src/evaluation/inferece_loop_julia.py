...
# Only generate from index 505 onwards
START_INDEX = 505
prompts_subset = prompts[START_INDEX:]
...
# Only save real validation images from 505 onwards
...
for model_name, step_count in models:
    ...
    # i starts at 505 so filenames match your friend's naming convention
    for i, prompt in enumerate(prompts_subset, start=START_INDEX):
